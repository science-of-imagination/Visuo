...
def create_examples(filename):
    ...
    picklingfile = open("savefile_TOTESTLINUX.txt", "wb")
...
if __name__ == '__main__':
    ...
    if loadOrNot == "y":
        ...
        picklingfile = open(input(), "rb")   ##To change the name of the file, change the input() to the name of the file you wish to load in between ""
...
##        picklingfile = input()
    ...
    if TRAINING == "y":
        ...
        EXAMPLE_FILE = "newfiletake6.txt"				## Input the name of the file containing said dataset
